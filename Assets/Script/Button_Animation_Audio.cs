...
public class Button_Animation_Audio : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(count == 1){
            ...
            ButtonSelect(Number_Audio_3D.rnd1);
             if(dis>=-0.013f){
        ...
        if(count == 2){
            float dis = Circle.transform.position.z + Distance-0.023f;
            ButtonSelect(Number_Audio_3D.rnd2);
             if(dis>=-0.013f){
                Transform ButtonTransform = Push_Button.transform;
                Vector3 Button_position = ButtonTransform.position;
                Button_position.z = 0.01f;
        ...
        if(count == 3){
             float dis = Circle.transform.position.z + Distance-0.023f;
            ButtonSelect(Number_Audio_3D.rnd3);
             if(dis>=-0.013f){
                Transform ButtonTransform = Push_Button.transform;
                Vector3 Button_position = ButtonTransform.position;
                Button_position.z = 0.01f;
        ...
        if(count == 4){
             float dis = Circle.transform.position.z + Distance-0.023f;
            ButtonSelect(Number_Audio_3D.rnd4);
             if(dis>=-0.013f){
                Transform ButtonTransform = Push_Button.transform;
                Vector3 Button_position = ButtonTransform.position;
                Button_position.z = 0.01f;
        ...
        if(count == 5){
             float dis = Circle.transform.position.z + Distance-0.023f;
            ButtonSelect(Number_Audio_3D.rnd5);
             if(dis>=-0.013f){
                Transform ButtonTransform = Push_Button.transform;
                Vector3 Button_position = ButtonTransform.position;
                Button_position.z = 0.01f;
        ...
        if(count == 6){
             float dis = Circle.transform.position.z + Distance-0.023f;
            ButtonSelect(Number_Audio_3D.rnd6);
             if(dis>=-0.013f){
                Transform ButtonTransform = Push_Button.transform;
                Vector3 Button_position = ButtonTransform.position;
                Button_position.z = 0.01f;
        ...
        if(count == 7){
             float dis = Circle.transform.position.z + Distance-0.023f;
            ButtonSelect(Number_Audio_3D.rnd7);
             if(dis>=-0.013f){
                Transform ButtonTransform = Push_Button.transform;
                Vector3 Button_position = ButtonTransform.position;
                Button_position.z = 0.01f;
